...
class Order extends Model
{
    ...
    public const PAYMENT_METHOD_INTERNATIONAL_TRANSFER = 'international_transfer';
    public const PAYMENT_METHOD_MOMO = 'momo';
    public const PAYMENT_METHOD_MOMO_ATM = 'momo_atm';
    public const PAYMENT_METHOD_MOMO_CC = 'momo_cc';
    ...
    public function getPaymentLabelAttribute(): string
    {
        return match ($this->payment_method) {
            self::PAYMENT_METHOD_COD, self::PAYMENT_METHOD_CASH => 'Tiền mặt khi nhận hàng',
            self::PAYMENT_METHOD_BANK_TRANSFER => 'Chuyển khoản nội địa',
            self::PAYMENT_METHOD_INTERNATIONAL_TRANSFER => 'Chuyển khoản quốc tế',
            self::PAYMENT_METHOD_MOMO => 'MoMo',
            self::PAYMENT_METHOD_MOMO_ATM => 'MoMo Nội địa',
            self::PAYMENT_METHOD_MOMO_CC => 'MoMo Quốc tế',
