...
return [
    ...
    */
    ...
    'momo' => [
        // MOMO_ENDPOINT is kept for older local .env files; the split keys are
        // easier to configure and match the payment service contract.
        'endpoint' => env('MOMO_ENDPOINT'),
        'base_url' => env('MOMO_BASE_URL'),
        'create_endpoint' => env('MOMO_CREATE_ENDPOINT'),
