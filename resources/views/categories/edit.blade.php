    ...
    <form action="{{ route('categories.update', $category->id) }}" method="POST">
        ...
        <div class="info-card" style="background-color: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px; padding: 20px; margin-bottom: 20px;">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" rows="4" placeholder="Mô tả ngắn về kiểu dáng hoặc đặc điểm danh mục...">{{ old('description', $category->description) }}</textarea>
            </div>
        </div>
