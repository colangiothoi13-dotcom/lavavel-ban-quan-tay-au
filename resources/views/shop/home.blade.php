...
<style>
    ...
    .hero-search { display: flex; justify-content: center; max-width: 600px; margin: 0 auto; border: 1px solid #cbd5e1; border-radius: 30px; background: #fff; overflow: hidden; }
