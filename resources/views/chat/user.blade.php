...
<style>
    ...
    .chat-message.is-mine .chat-author {
        color: #fff;
    }
    .chat-body {
        margin: 0;
    ...
    .chat-compose textarea:focus {
        border-color: #b4860b;
        outline: 2px solid rgba(180, 134, 11, 0.18);
    }
    .chat-compose button {
        min-height: 48px;
        padding: 0 20px;
...
>
    ...
    <div class="chat-panel chat-panel--white">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!userRoot) return;
        userRoot.dataset.scriptReady = 'true';
    });
</script>
