        ...
        <aside>
            <section class="detail-card cost-card">
                ...
                <dl>
                    ...
                    <div class="discount"><dt>Voucher giảm giá</dt><dd>-{{ number_format($voucherDiscount, 0, ',', '.') }} đ</dd></div>
